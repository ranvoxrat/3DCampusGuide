(function($) {
  ...
  $(function() {
    ...
    if ($("#traffic-chart").length) {
      ...
      var gradientStrokeViolet = ctx.createLinearGradient(0, 0, 0, 300);
      gradientStrokeViolet.addColorStop(0, 'rgba(227,10,146)');
      gradientStrokeViolet.addColorStop(1, 'rgba(227,10,146)');
      var gradientLegendViolet = 'linear-gradient(to right, rgba(227,10,146), rgba(227,10,146,234))';
      
      var gradientStrokeYellow = ctx.createLinearGradient(0, 0, 0, 300);
      gradientStrokeYellow.addColorStop(0, 'rgba(250,234,10)');
      gradientStrokeYellow.addColorStop(1, 'rgba(250,234,10)');
      var gradientLegendYellow = 'linear-gradient(to right, rgba(250,234,10), rgba(250,234,10))';
